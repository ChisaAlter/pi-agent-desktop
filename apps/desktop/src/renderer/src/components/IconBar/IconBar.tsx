...
export const IconBar: React.FC<IconBarProps> = ({ activePanel, onPanelChange }) => {
  ...
  return (
    <div className="w-12 bg-white border-r border-[#e5e5e5] flex flex-col items-center py-3 gap-1">
      {/* Logo */}
      <div className="w-8 h-8 bg-[#1a1a1a] rounded-lg flex items-center justify-center mb-4">
