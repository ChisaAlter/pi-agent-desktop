      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="flex gap-3 mb-3">
          <textarea
            ...
            placeholder={isConnected ? '描述你的任务...' : 'Pi CLI 未连接...'}
            className="flex-1 px-4 py-3 bg-[#f5f5f5] border border-[#e5e5e5] rounded-xl text-sm text-[#1a1a1a] placeholder:text-[#999] resize-none focus:outline-none focus:border-[#1a1a1a] disabled:opacity-50 min-h-[48px]"
            rows={1}
