...
export function ThinkingBlock({
  ...
  return (
    <div className="my-2 border-l border-[#e5e5e2] pl-3">
      <button
      ...
      >
        ...
        <div className="flex items-center gap-2">
          ...
          <svg
            className={`h-3 w-3 text-[#b0b0b0] transition-transform duration-150 ${
      ...
      {isExpanded && (
        <div className="py-2">
          <div className="whitespace-pre-wrap text-sm leading-relaxed text-[#777]">
            {content}
            {isStreaming && (
